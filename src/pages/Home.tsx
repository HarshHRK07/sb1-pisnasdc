    ...
    <div className="bg-white">
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Your Laundry, Our Ninja Way
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Experience lightning-fast laundry and dry cleaning services with our ninja-swift delivery. Professional care for your garments, right at your doorstep.
                </p>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Faster service</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need for pristine clothes
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            From everyday laundry to delicate dry cleaning, we handle your garments with the care they deserve.
          </p>
        </div>
      </div>
    </div>
